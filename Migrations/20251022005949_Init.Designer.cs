...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CrazyLizard.Entities.Block", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CrazyLizard.Entities.Circle", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CrazyLizard.Entities.Feedback", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CrazyLizard.Entities.Issue", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CrazyLizard.Entities.Notification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CrazyLizard.Entities.Post", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CrazyLizard.Entities.Recipient", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CrazyLizard.Entities.Reports.Report", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CrazyLizard.Entities.Subscription", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CrazyLizard.Entities.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CrazyLizard.Entities.Word", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("CrazyLizard.Entities.Reports.PostReport", b =>
                {
                    b.HasBaseType("CrazyLizard.Entities.Reports.Report");
            ...
            modelBuilder.Entity("CrazyLizard.Entities.Reports.UserReport", b =>
                {
                    b.HasBaseType("CrazyLizard.Entities.Reports.Report");
            ...
            modelBuilder.Entity("CrazyLizard.Entities.Block", b =>
                {
                    b.HasOne("CrazyLizard.Entities.User", "Blocked")
                        .WithMany("BlockedList")
                        .HasForeignKey("BlockedId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CrazyLizard.Entities.User", "Blocker")
            ...
            modelBuilder.Entity("CrazyLizard.Entities.Feedback", b =>
                {
                    b.HasOne("CrazyLizard.Entities.User", "User")
                        .WithMany("Feedback")
            ...
            modelBuilder.Entity("CrazyLizard.Entities.Issue", b =>
                {
                    b.HasOne("CrazyLizard.Entities.Circle", "Circle")
                        .WithMany("Issues")
            ...
            modelBuilder.Entity("CrazyLizard.Entities.Notification", b =>
                {
                    b.HasOne("CrazyLizard.Entities.Circle", "Circles")
                        .WithMany("Notifications")
                        .HasForeignKey("CirclesId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CrazyLizard.Entities.User", "Recipient")
                        .WithMany("Notifications")
            ...
            modelBuilder.Entity("CrazyLizard.Entities.Post", b =>
                {
                    b.HasOne("CrazyLizard.Entities.User", "Author")
                        .WithMany("Posts")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CrazyLizard.Entities.Issue", "Issue")
                        .WithMany("Posts")
            ...
            modelBuilder.Entity("CrazyLizard.Entities.Recipient", b =>
                {
                    b.HasOne("CrazyLizard.Entities.User", "Manager")
                        .WithMany("Recipients")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<long>", b =>
                {
                    b.HasOne("CrazyLizard.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CrazyLizard.Entities.Reports.PostReport", b =>
                {
                    b.HasOne("CrazyLizard.Entities.User", "FilingUser")
                        .WithMany("SnapshotReports")
                        .HasForeignKey("FilingUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CrazyLizard.Entities.Post", "Post")
                        .WithMany("Reports")
            ...
            modelBuilder.Entity("CrazyLizard.Entities.Reports.UserReport", b =>
                {
                    ...
                    b.HasOne("CrazyLizard.Entities.Circle", "Gathering")
                        .WithMany()
                        .HasForeignKey("GatheringId");

                    b.HasOne("CrazyLizard.Entities.User", "ReportedUser")
