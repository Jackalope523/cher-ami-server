    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "SneakyNick", "", new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), 0, false, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "The Dev Circle" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "AccountStatus", "AvatarPath", "AvatarTimestamp", "CircleId", "CircleJoinDate", "ConcurrencyStamp", "DateOfBirth", "Email", "EmailConfirmed", "FirstName", "GoogleId", "IssuePosts", "IssueReminders", "JoinDate", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "NotificationId", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "ProvidedPaymentDetails", "SecurityStamp", "SoftDeleted", "StripeCustomerId", "StripeSubscriptionId", "TimeOfUserAgreement", "Title", "TwoFactorEnabled", "UserName" },
                values: new object[,]
                {
                    { 2L, 0, 0, null, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), 1L, null, "d4a1c1e2-7f42-4f9c-b9c0-fd6bce2a1d55", new DateOnly(1, 1, 1), null, false, "CANARY", null, true, true, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, false, null, null, null, null, null, "+15734922666", false, false, "b1f4e3c2-1234-4567-8901-abcdefabcdef", false, null, null, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, false, null },
                    { 7L, 0, 0, null, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), 1L, null, "d4a1c1e2-7f42-4f9c-b9c0-fd6bce2a1d55", new DateOnly(1, 1, 1), null, false, "Apple Test Account", null, true, true, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, false, null, null, null, null, null, "+11002003007", false, false, "b1f4e3c2-1234-4567-8901-abcdefabcdef", false, null, null, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, false, null },
                    { 8L, 0, 0, null, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), 1L, null, "d4a1c1e2-7f42-4f9c-b9c0-fd6bce2a1d55", new DateOnly(1, 1, 1), null, false, "Google Test Account", null, true, true, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, false, null, null, null, null, null, "+11002003008", false, false, "b1f4e3c2-1234-4567-8901-abcdefabcdef", false, null, null, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, false, null }
                });
